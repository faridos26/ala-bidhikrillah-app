...
import { SalahGuideSection } from "./components/SalahGuideSection";
...
export default function Home() {
  ...
  const textToRead = useMemo(() => {
    switch (tab) {
      ...
      case "salah":
        return "قسم الصلاة. إن الصلاة كانت على المؤمنين كتابا موقوتا. تعرف على أركان الصلاة، وأذكار الركوع والسجود، والدعاء بعد التشهد قبل السلام، وأذكار ما بعد السلام، والدعاء بين الأذان والإقامة، والسنن الرواتب والنوافل.";
      case "categories":
        return "قسم المواضيع. تصفح الفئات المختلفة مثل الحزن والقلق والفرح والأمل، أو ابحث في الآيات والأدعية.";
      case "stories":
        return "قسم القصص. اختر قصة لتقرأها، فيها قصص الأنبياء وقصص هادفة للأطفال.";
      case "shahada":
        return "قسم نطق الشهادة. أشهد أن لا إله إلا الله، وأشهد أن محمدا رسول الله. اضغط على كل كلمة لسماع نطقها الصحيح.";
      case "mosques":
        return "قسم المساجد. تعرّف على أجمل المساجد في العالم، من المسجد الحرام والمسجد النبوي والمسجد الأقصى، إلى جامع الزيتونة والقيروان وجامع القرويين والأزهر وآيا صوفيا والجامع الأزرق وغيرها.";
      case "adhan":
        return "قسم الأذان. استمع إلى الأذان بأصوات مؤذنين مختلفين، واقرأ نص الأذان ومعانيه، وتعلم آداب الأذان والإقامة.";
      case "umrah":
        return "قسم العمرة. تعلم خطوات العمرة كاملة، من الإحرام إلى الحلق أو التقصير، مع الأدعية والملاحظات والمحظورات.";
      case "madhabs":
        return "قسم المذاهب الفقهية. نبذة تعريفية محايدة عن المذاهب الأربعة: الحنفي والمالكي والشافعي والحنبلي.";
      case "asma":
        return "قسم أسماء الله الحسنى. تسعة وتسعون اسما من أسماء الله، مع معانيها وشرحها. يمكنك البحث والاستماع لكل اسم.";
      case "tasbih":
        return "قسم التسبيح. عداد إلكتروني للتسبيح. اضغط على الدائرة للعد.";
      case "favorites":
        return "قسم المحفوظات. هنا تجد المحتوى الذي حفظته من الآيات والأدعية والقصص.";
      default:
        return "";
    }
  }, [tab, result, content]);
